    ...
    <footer>
        <div class="footer-container">
            <ul class="footer-logo">
                <img :src="url + general2.data.attributes.FooterLogo.data.attributes.url" alt="">
            </ul>
            <ul>
                <h4>Was jetzt?</h4>
...
<script setup lang="ts">
    ...
    const {data: general2} = await useAsyncData('general2', () => find('general', {
